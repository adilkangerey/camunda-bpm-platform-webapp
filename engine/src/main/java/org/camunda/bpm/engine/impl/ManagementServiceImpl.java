...
public class ManagementServiceImpl extends ServiceImpl implements ManagementService {
  ...
  @Override
  public Map<String, Meter> getMetrics() {
    // TODO just a demonstration how to integrate this, this should probably return a sample of metrics including labeled dimensions (e.g. metrics by processDefinitionKey)
    return commandExecutor.execute(context -> context.getProcessEngineConfiguration().getMetricsRegistry().getDbMeters());
  }
