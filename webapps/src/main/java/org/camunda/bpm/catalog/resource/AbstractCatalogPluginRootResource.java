 ...
 *
 */
public class AbstractCatalogPluginRootResource extends AbstractAppPluginRootResource<CatalogPlugin> {

  public AbstractCatalogPluginRootResource(String pluginName) {
    super(pluginName, Catalog.getRuntimeDelegate());
  }
