 ...
 */
package org.camunda.bpm.catalog.impl.web;
...
public class CatalogApplication extends Application {
  ...
  private void addPluginResourceClasses(Set<Class<?>> classes) {
    ...
    List<CatalogPlugin> plugins = getPlugins();
  ...
  private List<CatalogPlugin> getPlugins() {
    return Catalog.getRuntimeDelegate().getAppPluginRegistry().getPlugins();
  }
